...
# not importable however sensible the cwd is — the command in the docstring
# above needed PYTHONPATH=. in front of it to work at all. Same bootstrap as
# scripts/seed_fire_frequency_master.py.
